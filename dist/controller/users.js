...
exports.tokencheck = exports.logIn = exports.createUsers = void 0;
...
var tokencheck = exports.tokencheck = function tokencheck(req, res, next) {
  var token = req.headers.authorization.split(" ")[1];
  _jsonwebtoken["default"].verify(token, clave, function (err, usuario) {
    if (err) {
